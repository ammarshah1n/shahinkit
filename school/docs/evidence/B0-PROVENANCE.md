...
| Codex | `0.144.5` | `>=0.144.5 <0.145.0` | `CODEX_VERSION` | `https://github.com/openai/codex/releases/tag/rust-v0.144.5` | `https://developers.openai.com/codex/config-schema.json`, `https://github.com/openai/codex/blob/c10010928075babeebfc65b824db8778f10a1c56/codex-rs/core/src/config/schema.md`, and `https://raw.githubusercontent.com/openai/codex/c10010928075babeebfc65b824db8778f10a1c56/codex-rs/core/config.schema.json` |
...
| Codex | User config is `config.toml`; trusted projects can load `.codex/config.toml`; canonical skills are `~/.agents/skills` for user scope and `.agents/skills` for project scope; `.codex/skills` is deprecated compatibility only. Config validates against Draft-07 `ConfigToml`; project config must not set user-global provider, approval, sandbox, network, trust, credential, notification, or telemetry controls. | `https://github.com/openai/codex/blob/rust-v0.144.5/codex-rs/core-skills/src/loader.rs`, `https://developers.openai.com/codex/config-file/config-reference/`, and `https://developers.openai.com/codex/config-schema.json` |
...
- Codex: `https://github.com/openai/codex/releases/tag/rust-v0.144.5`, `https://github.com/openai/codex/blob/rust-v0.144.5/codex-rs/core-skills/src/loader.rs`, `https://developers.openai.com/codex/config-file/config-reference/`, and `https://developers.openai.com/codex/config-schema.json`.
