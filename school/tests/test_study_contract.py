...
SKILL = ROOT / "school/shared/skills/study/SKILL.md"
...
class StudyContractTests(unittest.TestCase):
    ...
    def test_all_adapters_render_one_canonical_study_skill(self):
        ...
        self.assertIn(("school/shared/skills/study/SKILL.md", "skills/study/SKILL.md"), claude)
    ...
    def test_manifest_and_acceptance_checklist_are_complete_and_synced(self):
        ...
        self.assertIn("school/shared/skills/study/SKILL.md", owned)
        self.assertIn("school/docs/STUDY-ACCEPTANCE-v1.md", owned)
        ...
        checklist = (ROOT / "school/docs/STUDY-ACCEPTANCE-v1.md").read_text()
        for case in (
    ...
    def test_readme_says_lifecycle_commands_are_explicit(self):
        ...
        self.assertIn("`/prime` and `/wrap-up` are not automatic lifecycle hooks", readme)
        self.assertIn("hidden transcript capture or surprise writes", readme)
