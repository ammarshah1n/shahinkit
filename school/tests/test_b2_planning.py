...
class B2PlanningSkillTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        fixture_root = ROOT / "school/tests/fixtures/b2/planning"
    ...
    def skill_text(self, skill):
        return (ROOT / "school/shared/skills" / skill / "SKILL.md").read_text()
    ...
    def test_delegation_roles_match_shared_schema(self):
        schema = json.loads((ROOT / "school/shared/models/roles.schema.json").read_text())
