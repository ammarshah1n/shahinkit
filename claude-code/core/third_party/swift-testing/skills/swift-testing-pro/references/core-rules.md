...
**Important:** Swift Testing does *not* support UI tests. This portable skill does not create or automate UI tests; report that capability as unavailable and preserve the project's existing approach unless the user explicitly requests a separate, project-supported solution.
